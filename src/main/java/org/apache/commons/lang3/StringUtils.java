...
public class StringUtils {
    ...
    /**
     * Prepares an ellipsis {@link CharSequence} for {@link java.util.Formattable} truncation helpers.
     * <p>
     * A {@code null} ellipsis is treated as {@link #EMPTY} (hard truncation with no suffix). An explicit empty
     * sequence {@code ""} is left semantically equivalent to hard truncation.
     * </p>
     *
     * @param ellipsis ellipsis argument from a formattable append, may be null.
     * @return non-null sequence to substitute when replacing overflow characters.
     */
    public static CharSequence normalizeFormattableEllipsis(final CharSequence ellipsis) {
        if (ellipsis == null) {
            return EMPTY;
        }
